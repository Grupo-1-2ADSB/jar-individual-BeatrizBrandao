...
public class NotificacaoRAM {
    public static void exibirNotificacao() {
        try {
            ...
            trayIcon.displayMessage("Devido à alta ocupação da memória, ", "precisaremos fechar alguns programas para melhorar o desempenho. Não se preocupe, isso não afetará o seu trabalho.", TrayIcon.MessageType.WARNING);
        } catch (Exception ex) {
